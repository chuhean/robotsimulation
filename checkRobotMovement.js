//This function will check whether the robot movement and direction is valid. If not, it will undo the movement and show error to user.
...
module.exports = {
  checkRobotMovement: function(x, y, f) {
